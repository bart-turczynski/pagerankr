...
<!-- No coverage badge: the coverage job was not ported to GitLab CI, and      Codecov still holds this project under a `/gh/` path. A badge reporting      nothing is worse than no badge. -->
<!-- badges: end -->
