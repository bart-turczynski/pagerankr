...
#
# `oysteR::expect_secure("pagerankr")` resolves the installed DESCRIPTION and
# audits pagerankr's declared dependencies against the Sonatype OSS Index. It is
# a network test that requires OSS Index credentials (OSSINDEX_USER /
...
test_that("declared dependencies have no known OSS Index vulnerabilities", {
  ...
  oysteR::expect_secure("pagerankr")
})
