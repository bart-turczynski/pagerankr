...
1. ~~**Recurrence threshold**: user-facing or fixed?~~ **Answered (§10): user-facing.** Not
   ...
   (~0.5% of pairs on vendor-b.example.com), so threshold choice has *low leverage* rather than *no*
...
| `_scratch/crawls/vendor-b.example.com/` | 9,655 | 2,344,199 | large, uncleaned, multilingual |
...
Whether the ~500 pairs in vendor-b.example.com's 0.5–0.9 band are genuinely ambiguous or noise. That decides
