...
#' @details
#' As part of the workflow, any edge where either from or to is NA is automatically dropped before deduplication and PageRank calculation. Self-referencing redirects (where from == to) are also filtered out before redirect resolution. 