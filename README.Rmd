...
`pagerankr` is an SEO-focused R toolkit for PageRank modelling on crawl data.
...
- `clean_url_columns()` canonicalises URL columns using `rurl::get_clean_url`
...
- `analyze_pagerank_grid()` summarises concentration/distribution effects
...
- `launch_pagerank_explorer()` launches an interactive Shiny app for uploads,
  visualisation, redirect auditing, and exports
